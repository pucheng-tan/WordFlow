...
if __name__ == "__main__":
    ...
    try:
        ...
        new_user: UserRecord = auth.create_user(email=email, password=password)
        
        print(new_user.email)
        print('Firebase successfully created a new user with email: ' + new_user.email + 'and user id:' + new_user.uid)
        pass
