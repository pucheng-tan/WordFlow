...
firebase = firebase.FirebaseApplication('https://cmpt370-group2.firebaseio.com')
...
print("Since I have ran the PoC multiple times, when I try to get the /test dir, I see lots of data")
print(" this is starting to get hard to read")
print(result)

#use firebase put command to change data in firebase
firebase.put('/test/-MIHzxRT4UJL4YFBt1lf','Email','cameronmcleod71@gmail.com')
